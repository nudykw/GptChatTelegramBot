...
> [!NOTE]
> **Гілка**: `feature/web-api-minimal`  
> Цей посібник описує розгортання **веб-версії** бота (`TelegramBotWebApp`).  
> Консольну версію (`TelegramBotApp`) можна запустити локально — див. [Швидкий старт](../README.uk.md#-швидкий-старт).
